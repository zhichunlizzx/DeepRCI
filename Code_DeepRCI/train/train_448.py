...
def main():
    ...
    path_feature_0_train = r'H:\DeepRCI_data\data_448\009\train\0\\'
    path_feature_1_train = r'H:\DeepRCI_data\data_448\009\train\1\\'

    # path_feature_00_val = r'F:\data_xmm\validation\0\\'
    # path_feature_11_val = r'F:\data_xmm\validation\1\\'
    path_feature_0_val = r'H:\DeepRCI_data\data_448\009\validation\0\\'
    path_feature_1_val = r'H:\DeepRCI_data\data_448\009\validation\1\\'
    path_feature_000_val = r'H:\DeepRCI_data\data_448\lingdian1\validation\00\\'
    ...
    db_train = db_train.map(preprocess).shuffle(1000000).batch(5)
