...
class XmmNet0(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # unit 1
        self.conv1 = tf.keras.layers.Conv2D(96, kernel_size=[8, 8], padding="same", activation=tf.nn.relu, strides=2)
        self.bn1 = tf.keras.layers.BatchNormalization()
        self.conv12 = tf.keras.layers.Conv2D(64, kernel_size=[5, 5], padding="same", activation=tf.nn.relu)
        self.bn12 = tf.keras.layers.BatchNormalization()
        self.pool1 = tf.keras.layers.MaxPool2D(pool_size=[3, 3], strides=2, padding='same')

        # unit 2
        self.conv2 = tf.keras.layers.Conv2D(192, kernel_size=[3, 3], padding="same", activation=tf.nn.relu, strides=2)
        ...
        # unit 3
        self.conv3 = tf.keras.layers.Conv2D(384, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn3 = tf.keras.layers.BatchNormalization()
        self.conv4 = tf.keras.layers.Conv2D(384, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn4 = tf.keras.layers.BatchNormalization()
        self.pool3 = tf.keras.layers.MaxPool2D(pool_size=[2, 2], strides=2, padding='same')

        # unit 4
        self.conv5 = tf.keras.layers.Conv2D(384, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn5 = tf.keras.layers.BatchNormalization()
        self.conv6 = tf.keras.layers.Conv2D(384, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn6 = tf.keras.layers.BatchNormalization()
        self.pool5 = tf.keras.layers.MaxPool2D(pool_size=[3, 3], strides=2, padding='same')

        self.conv7 = tf.keras.layers.Conv2D(384, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn7 = tf.keras.layers.BatchNormalization()
        self.pool6 = tf.keras.layers.MaxPool2D(pool_size=[3, 3], strides=2, padding='same')

        # unit 5
        # self.conv9 = tf.keras.layers.Conv2D(512, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        # self.bn9 = tf.keras.layers.BatchNormalization()
        # self.conv10 = tf.keras.layers.Conv2D(512, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        # self.bn10 = tf.keras.layers.BatchNormalization()
        # self.pool5 = tf.keras.layers.MaxPool2D(pool_size=[4, 4], strides=4, padding='same')
        #
        ...
        # self.bn12 = tf.keras.layers.BatchNormalization()
        # self.pool6 = tf.keras.layers.MaxPool2D(pool_size=[4, 4], strides=4, padding='same')
        ...
        # self.fc2 = tf.keras.layers.Dense(128, activation=tf.nn.relu)
        self.fc3 = tf.keras.layers.Dense(64, activation=tf.nn.relu)
        self.fc4 = tf.keras.layers.Dense(2, activation=tf.nn.relu)
