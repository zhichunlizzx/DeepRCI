import numpy as np
import pandas as pd
from network_ss import CMM_NET
...
def main():
    ...
    path_test = r'E:\data\SS\val\val.csv'

    feature_train, label_train = get_feature(path_train, 9)
    feature_test, label_test = get_feature(path_test, 9)
    ...
    for epoch in range(2000):
        ...
        if acc > 0.76:
            with open(r'H:\400\y_score_ss.txt', 'a') as w_obj:
                w_obj.write(str(acc))
                w_obj.write('\n')
