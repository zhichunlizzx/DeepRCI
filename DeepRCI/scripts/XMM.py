...
class XmmNet0(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # unit 1
        self.conv1 = tf.keras.layers.Conv2D(64, kernel_size=[7, 7],strides=2, activation=tf.nn.relu)
        ...
        # unit 2
        self.conv3 = tf.keras.layers.Conv2D(128, kernel_size=[5, 5], strides=2, activation=tf.nn.relu)
        ...
        # unit 3
        self.conv5 = tf.keras.layers.Conv2D(256, kernel_size=[3, 3], strides=2, activation=tf.nn.relu)
        ...
        # unit 4
        self.conv7 = tf.keras.layers.Conv2D(512, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn7 = tf.keras.layers.BatchNormalization()
        self.conv8 = tf.keras.layers.Conv2D(512, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn8 = tf.keras.layers.BatchNormalization()
        self.pool4 = tf.keras.layers.MaxPool2D(pool_size=[2, 2], strides=2, padding='same')

        # unit 5
        self.conv9 = tf.keras.layers.Conv2D(762, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn9 = tf.keras.layers.BatchNormalization()
        self.conv10 = tf.keras.layers.Conv2D(762, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn10 = tf.keras.layers.BatchNormalization()
        self.pool5 = tf.keras.layers.MaxPool2D(pool_size=[2, 2], strides=2, padding='same')

        self.conv11 = tf.keras.layers.Conv2D(762, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn11 = tf.keras.layers.BatchNormalization()
        self.conv12 = tf.keras.layers.Conv2D(762, kernel_size=[3, 3], padding="same", activation=tf.nn.relu)
        self.bn12 = tf.keras.layers.BatchNormalization()
        self.pool6 = tf.keras.layers.MaxPool2D(pool_size=[2, 2], strides=4, padding='same')
