...
def main():
    path_feature_0_train = r'H:\DeepRCI_data\data_400\011\train\0\\'
    path_feature_1_train = r'H:\DeepRCI_data\data_400\011\train\1\\'

    # path_feature_00_val = r'F:\data_xmm\validation\0\\'
    # path_feature_11_val = r'F:\data_xmm\validation\1\\'
    path_feature_0_val = r'H:\DeepRCI_data\data_400\011\validation\0\\'
    path_feature_1_val = r'H:\DeepRCI_data\data_400\011\validation\1\\'
    path_feature_000_val = r'H:\DeepRCI_data\data_400\007\validation\00\\'
    ...
    db_train = db_train.map(preprocess).shuffle(1000000).batch(6)
