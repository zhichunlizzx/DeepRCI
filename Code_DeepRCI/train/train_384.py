...
def main():
    path_feature_0_train = r'H:\DeepRCI_data\384\train\0\\'
    path_feature_1_train = r'H:\DeepRCI_data\384\train\1\\'

    # path_feature_00_val = r'F:\data_xmm\validation\0\\'
    # path_feature_11_val = r'F:\data_xmm\validation\1\\'
    path_feature_0_val = r'H:\DeepRCI_data\384\validation\0\\'
    path_feature_1_val = r'H:\DeepRCI_data\384\validation\1\\'
    path_feature_000_val = r'H:\DeepRCI_data\384\validation\00\\'
    ...
    model = xmm1()
    model.build(input_shape=(None, 384, 384, 4))
    # model.summary()
    learning_r = 1e-4
