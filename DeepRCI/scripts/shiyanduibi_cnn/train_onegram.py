import numpy as np
import pandas as pd
from network_onegram import CMM_NET
...
def main():
    path_train = r'E:\data\AAC\one_gram\onegram.csv'
    path_test = r'E:\data\AAC\one_gram\onegram_val.csv'
    ...
    for epoch in range(2000):
        ...
        if acc > 0.82:
            with open(r'H:\400\y_score_onegram.txt', 'a') as w_obj:
                w_obj.write(str(acc))
                w_obj.write('\n')
