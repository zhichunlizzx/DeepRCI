import numpy as np
import pandas as pd
from network_two_gram import CMM_NET
...
def main():
    ...
    feature_train, label_train = get_feature(path_train, 400)
    feature_test, label_test = get_feature(path_test, 400)
    ...
    for epoch in range(2000):
        ...
        if acc > 0.77:
            with open(r'H:\400\y_score_twogram.txt', 'a') as w_obj:
                w_obj.write(str(acc))
                w_obj.write('\n')
