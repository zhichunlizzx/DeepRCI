...
from deep_xmm_type04 import xmm1
...
def main():
    ...
    path_feature_00_val = r'F:\data_xmm\validation\000\\'
    img_dim = 256
    img_channels = 4
    ...
    path_val_1,label_val_1 = path_feature_label(path_feature_1_val,path_feature_00_val)
    ...
    db_train = db_train.map(preprocess).shuffle(1000000).batch(16)
    # ab = iter(db_train)
    # print(next(ab))
