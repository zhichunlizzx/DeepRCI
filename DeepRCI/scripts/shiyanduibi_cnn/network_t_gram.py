...
class CMM_NET(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.conv_1 = tf.keras.layers.Conv1D(32, kernel_size=2, padding='same', activation=tf.nn.relu)
        self.bn_1 = tf.keras.layers.BatchNormalization()
        self.conv_1_1 = tf.keras.layers.Conv1D(32, kernel_size=2, padding='same', activation=tf.nn.relu)
        ...
        self.conv_2 = tf.keras.layers.Conv1D(64, kernel_size=64, padding='same', activation=tf.nn.relu)
        self.bn_2 = tf.keras.layers.BatchNormalization()
        self.conv_2_2 = tf.keras.layers.Conv1D(64, kernel_size=64, padding='same', activation=tf.nn.relu)
        ...
        self.conv_3 = tf.keras.layers.Conv1D(128, kernel_size=2, padding='same', activation=tf.nn.relu)
        self.bn_3 = tf.keras.layers.BatchNormalization()
        self.conv_3_3 = tf.keras.layers.Conv1D(128, kernel_size=2, padding='same', activation=tf.nn.relu)
        ...
        self.conv_4 = tf.keras.layers.Conv1D(128, kernel_size=2, padding='same', activation=tf.nn.relu)
        ...
        self.fc_1 = tf.keras.layers.Dense(13, activation=tf.nn.relu)
